...
#define TOPIC      "rdurland/feeds/hw11.problem3"
#define AUTHMETHOD "rdurland"
#define AUTHTOKEN  "aio_aSzK63tjckb0wofAlUWjMOGHBAU0"
#define QOS        1
#define TIMEOUT    10000L
#define ADC_PATH   "/sys/bus/iio/devices/iio:device0/in_voltage"
#define ADC        0
#define buttonPin  46
#define buttonPath "/sys/class/gpio"

int readButton(int number)
{
   stringstream ss;
   ss << buttonPath << number;
   fstream fs;
...
int main(int argc, char* argv[]) {
   ...
   sprintf(str_payload, "%f", readButton(buttonPin));
